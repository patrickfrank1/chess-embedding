...
class ResnetAutoencoder(AutoencoderModel):
	...
	def _model_helper(self) -> dict:
		...
		conv_1 = layers.Conv3D(128, (2,2,15), activation="relu", padding="same")(encoder_input)
		conv_1 = layers.BatchNormalization()(conv_1)
		conv_2 = layers.Conv3D(256, (2,2,15), activation="relu", padding="same")(conv_1)
		...
		decoder_conv_1 = layers.Conv3DTranspose(128, (2,2,15), activation="relu", padding="same")(decoder_dense)
		decoder_conv_1 = layers.BatchNormalization()(decoder_conv_1)
		decoder_conv_2 = layers.Conv3DTranspose(1, (2,2,15), activation="relu", padding="same")(decoder_conv_1)
		ecoeder_conv_2 = layers.BatchNormalization()(decoder_conv_2)
		#decoder_conv_3 = layers.Conv3DTranspose(8, (2,2,15), activation="relu", padding="same")(decoder_conv_2)
